 ...
 *
 * @FieldFormatter(
 *   id = "nine_mobile_product_variant_field_formatter",
 *   label = @Translation("Product variant field formatter"),
 *   field_types = {
 *     "entity_reference"
 *   }
 * )
 */
class NineMobileProductVariantFieldFormatter extends FormatterBase {
